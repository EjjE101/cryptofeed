...
class TradeTimescale(TimescaleCallback, BackendCallback):
    ...
    def format(self, data: Tuple):
        ...
        return f"('{timestamp}','{receipt}','{symbol}','{data['side']}',{data['amount']},{data['price']},{id},{otype})"
...
class TickerTimescale(TimescaleCallback, BackendCallback):
...
class IndexTimescale(TimescaleCallback, BackendCallback):
    default_table = INDEX
...
class BookTimescale(TimescaleCallback, BackendBookCallback):
    ...
    def format(self, data: Tuple):
        exchange, symbol, timestamp, receipt, data = data
        return f"('{timestamp}','{receipt}','{symbol}',{data['bids']},'{data['ask']}')"



class CandlesTimescale(TimescaleCallback, BackendCallback):
